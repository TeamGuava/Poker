    ...
    public partial class GameEngine : Form
    {
            ...
            if (PFturn || !Pturn)
            {
                ...
                if (!B1Fturn)
                {
                    if (B1turn)
                    {
                        ...
                        AI(2, 3, ref bot1Chips, ref B1turn, ref  B1Fturn, bot1_StatusButton, 0, b1Power, b1Type);
                        turnCount++;
                        last = 1;
                        B1turn = false;
                        B2turn = true;
                ...
                if (!B2Fturn)
                {
                    if (B2turn)
                    {
                        ...
                        AI(4, 5, ref bot2Chips, ref B2turn, ref  B2Fturn, bot2_StatusButton, 1, b2Power, b2Type);
                        turnCount++;
                        last = 2;
                        B2turn = false;
                        B3turn = true;
                ...
                if (!B3Fturn)
                {
                    if (B3turn)
                    {
                        ...
                        AI(6, 7, ref bot3Chips, ref B3turn, ref  B3Fturn, bot3_StatusButton, 2, b3Power, b3Type);
                        turnCount++;
                        last = 3;
                        B3turn = false;
                        B4turn = true;
                ...
                if (!B4Fturn)
                {
                    if (B4turn)
                    {
                        ...
                        AI(8, 9, ref bot4Chips, ref B4turn, ref  B4Fturn, bot4_StatusButton, 3, b4Power, b4Type);
                        turnCount++;
                        last = 4;
                        B4turn = false;
                        B5turn = true;
                ...
                if (!B5Fturn)
                {
                    if (B5turn)
                    {
                        ...
                        AI(10, 11, ref bot5Chips, ref B5turn, ref  B5Fturn, bot5_StatusButton, 4, b5Power, b5Type);
                        turnCount++;
                        last = 5;
                        B5turn = false;
                    }
            ...
            else
            {
                if (turnCount >= maxLeft - 1 || !changed && turnCount == maxLeft)
                {
                    if (currentTurn == raisedTurn - 1 || !changed && turnCount == maxLeft || raisedTurn == 0 && currentTurn == 5)
                    {
                        ...
                        rounds++;
                        if (!PFturn)
                            player_StatusButton.Text = "";
                        if (!B1Fturn)
                            bot1_StatusButton.Text = "";
                        if (!B2Fturn)
                            bot2_StatusButton.Text = "";
                        if (!B3Fturn)
                            bot3_StatusButton.Text = "";
                        if (!B4Fturn)
                            bot4_StatusButton.Text = "";
                        if (!B5Fturn)
                            bot5_StatusButton.Text = "";
                    }
                }
            }
            if (rounds == Flop)
        ...
        async Task AllIn()
        {
            ...
            if (Chips <= 0 && !intsadded)
            {
                ...
                if (player_StatusButton.Text.Contains("Call"))
                {
                    ints.Add(Chips);
                    intsadded = true;
                }
        ...
        private void Update_Tick(object sender, object e)
        {
            ...
            if (raise_TextBox.Text != "" && int.TryParse(raise_TextBox.Text, out parsedValue))
            {
